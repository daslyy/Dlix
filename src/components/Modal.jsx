        ...
        <div className="p-6">
          <div className="flex flex-wrap items-center gap-3 mb-4 font-mono text-xs text-fog">
            {movie.vote_average > 0 && (
              <span className="text-marquee font-semibold">★ {movie.vote_average.toFixed(1)}</span>
            )}
          ...
          <div className="flex gap-3 mt-6">
            <button className="flex items-center gap-2 bg-paper text-void font-semibold px-6 py-2.5 rounded hover:bg-fog transition-colors">
              <PlayIcon /> Play
            </button>
